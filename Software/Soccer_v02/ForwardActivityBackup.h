...
#define LINE_LONG_MILLIS 700
#define LINE_SHORT_MILLIS 700
...
public:
	ForwardActivity(MoveController *_MC) {
		...
		maxDistClose[US_FRONT] = 23;
		maxDistClose[US_LEFT] = 23;
		maxDistClose[US_BACK] = 23;
		maxDistClose[US_RIGHT] = 23;
